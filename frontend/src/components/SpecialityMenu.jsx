...
const SpecialityMenu = () => {
  return (
    <div id='speciality' className='flex flex-col items-center gap-5 text-gray-800 py-16'>
      ...
      <p className='text-wrap text-center text-sm md:text-base font-normal'>Browse through our extensive list of trusted doctors, schedule your appointment hassle-free.</p>
